 ...
 */
final class Version20200209172051 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE figures ADD main_image VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE figures DROP main_image');
        $this->addSql('ALTER TABLE picture CHANGE updated_at updated_at DATETIME DEFAULT \'NULL\'');
