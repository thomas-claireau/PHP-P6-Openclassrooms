 ...
 */
final class Version20200208171553 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE figures ADD main_img_filename VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE figures DROP main_img_filename');
        $this->addSql('ALTER TABLE picture CHANGE updated_at updated_at DATETIME DEFAULT \'NULL\'');
